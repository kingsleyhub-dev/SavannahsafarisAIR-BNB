    ...
    <div className="container-luxe py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm text-primary-foreground/80">
          <li className="flex items-start gap-3"><MapPin className="size-4 mt-0.5 text-accent" /> {property.location}</li>
          <li className="flex items-start gap-3"><Phone className="size-4 mt-0.5 text-accent" /> {property.whatsapp}</li>
          <li className="flex items-start gap-3"><Mail className="size-4 mt-0.5 text-accent" /> {property.email}</li>
        </ul>
      </div>
    ...
    <div className="border-t border-white/10">
      <div className="container-luxe py-6 flex flex-col sm:flex-row justify-between gap-2 text-xs text-primary-foreground/60">
        ...
        <div className="flex gap-6">
          ...
          <a href="#" className="hover:text-accent">House Rules</a>
        </div>
      </div>
    </div>
  </footer>
